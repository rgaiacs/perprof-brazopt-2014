...
\begin{poster}
  ...
  \begin{posterbox}[column=1]{Features}
    ...
    \begin{center}
      \begin{tabular}{cc}
        \includegraphics[width=0.45\linewidth,height=110pt]{abc-bw-semilog.pdf} &
        \includegraphics[width=0.45\linewidth,height=110pt]{abc.pdf} \\
        Black and white & Linear scale \\
        \includegraphics[width=0.45\linewidth,height=110pt]{abc-100.pdf} &
        \includegraphics[width=0.45\linewidth,height=110pt]{abc-hs.pdf} \\
